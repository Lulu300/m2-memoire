...
\item \textbf{Gouvernance des données :} La gouvernance des données correspond à l'ensemble des procédures mise en place afin d'encadrer la collecte des données ainsi que leur utilisation. Le gouvernance des données comprend quatre dimensions. La disponibilité des données, l’utilisabilité des données, l'intégrité des données et la sécurité des données.
